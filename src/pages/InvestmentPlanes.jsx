...
import { headings, investmentPlanCard } from '../utils/investmentData'
...
function InvestmentPlanes() {
    ...
    const handleNotifyButton = () => {
        const message = encodeURIComponent("Hello! Notify me when courses are live...");
                    ...
                    <div className="w-full max-w-6xl mx-auto rounded-2xl bg-gradient-to-r from-indigo-500 via-fuchsia-500 to-pink-500 p-1 shadow-lg">
                        <div className="flex flex-col md:flex-row items-center justify-between bg-[#181818]/90 rounded-2xl px-6 py-5 gap-4">
                            ...
                            <button
                                ...
                                className="w-full md:w-fit mt-3 md:mt-0 bg-white/10 border border-white/20 text-white font-semibold px-6 py-2 rounded-xl text-base cursor-pointer opacity-70 flex items-center gap-2">
